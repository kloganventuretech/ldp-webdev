...
/**
 * Provides global initialization function for Chart.js
 * @author Alan Holt (aholt@venturetech.net)
 * @since 4/6/16 10:25 AM
 * @requires "Chart.js"
 * @requires "Gauge.js"
*/
...
function setupChart(target) {
    ...
    if(chartType != null) {
        var chart = chartType.createChart(canvas, data, options);
        if (chart && includeLegend && chartType.isLegendSupported) {
